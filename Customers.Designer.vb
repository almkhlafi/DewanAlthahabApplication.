...
Partial Class Customers
    ...
    Private Sub InitializeComponent()
        ...
        UpCustomersPB = New PictureBox()
        CountryCB = New ComboBox()
        AreaCB = New ComboBox()
        ClosingPB = New PictureBox()
        Delegations = New PictureBox()
        CustomerSearchPB = New PictureBox()
        ...
        CType(ClosingPB, ComponentModel.ISupportInitialize).BeginInit()
        GroupBox2.SuspendLayout()
        CType(Delegations, ComponentModel.ISupportInitialize).BeginInit()
        CType(CustomerSearchPB, ComponentModel.ISupportInitialize).BeginInit()
        CType(refreshPB, ComponentModel.ISupportInitialize).BeginInit()
        ...
        CurrencyDGV.Size = New Size(866, 146)
        ...
        GroupBox1.Size = New Size(1622, 885)
        ...
        GroupBox6.Location = New Point(0, 13)
        GroupBox6.Name = "GroupBox6"
        GroupBox6.Size = New Size(879, 178)
        ...
        GroupBox3.Controls.Add(downCustomersPB)
        GroupBox3.Controls.Add(UpCustomersPB)
        ...
        ActiveNoActiveCKB.ForeColor = SystemColors.Highlight
        ActiveNoActiveCKB.Location = New Point(427, 71)
        ActiveNoActiveCKB.Name = "ActiveNoActiveCKB"
        ActiveNoActiveCKB.Size = New Size(141, 24)
        ActiveNoActiveCKB.TabIndex = 75
        ...
        IdentityCommercialNameOptionCB.Size = New Size(150, 28)
        IdentityCommercialNameOptionCB.TabIndex = 10
        ' 
        ' CustomerSupplierCB
        ' 
        ...
        CustomerSupplierCB.Size = New Size(150, 28)
        CustomerSupplierCB.TabIndex = 9
        ' 
        ' ReferralNumberTB
        ' 
        ReferralNumberTB.Location = New Point(157, 815)
        ReferralNumberTB.Name = "ReferralNumberTB"
        ReferralNumberTB.Size = New Size(297, 27)
        ReferralNumberTB.TabIndex = 74
        ' 
        ' telephoneNumberTB
        ' 
        telephoneNumberTB.Location = New Point(464, 815)
        telephoneNumberTB.Name = "telephoneNumberTB"
        telephoneNumberTB.Size = New Size(200, 27)
        telephoneNumberTB.TabIndex = 73
        ' 
        ' telephoneNumberZipcodeTB
        ' 
        telephoneNumberZipcodeTB.Location = New Point(670, 815)
        telephoneNumberZipcodeTB.Name = "telephoneNumberZipcodeTB"
        telephoneNumberZipcodeTB.Size = New Size(55, 27)
        telephoneNumberZipcodeTB.TabIndex = 72
        ' 
        ' phoneNumber2TB
        ' 
        phoneNumber2TB.Location = New Point(460, 760)
        phoneNumber2TB.Name = "phoneNumber2TB"
        phoneNumber2TB.Size = New Size(200, 27)
        phoneNumber2TB.TabIndex = 71
        ' 
        ' phoneNumber1ZipCodeTB
        ' 
        phoneNumber1ZipCodeTB.Location = New Point(670, 760)
        phoneNumber1ZipCodeTB.Name = "phoneNumber1ZipCodeTB"
        phoneNumber1ZipCodeTB.Size = New Size(55, 27)
        phoneNumber1ZipCodeTB.TabIndex = 70
        ' 
        ' FaxNumberTB
        ' 
        FaxNumberTB.Location = New Point(157, 760)
        FaxNumberTB.Name = "FaxNumberTB"
        FaxNumberTB.Size = New Size(297, 27)
        FaxNumberTB.TabIndex = 69
        ' 
        ' phoneNumber1TB
        ' 
        phoneNumber1TB.Location = New Point(462, 687)
        phoneNumber1TB.Name = "phoneNumber1TB"
        phoneNumber1TB.Size = New Size(201, 27)
        phoneNumber1TB.TabIndex = 68
        ' 
        ' emailTB
        ' 
        emailTB.Location = New Point(151, 688)
        emailTB.Name = "emailTB"
        emailTB.Size = New Size(303, 27)
        emailTB.TabIndex = 67
        ' 
        ' VTRnumberTB
        ' 
        VTRnumberTB.Location = New Point(489, 574)
        VTRnumberTB.Name = "VTRnumberTB"
        VTRnumberTB.Size = New Size(229, 27)
        VTRnumberTB.TabIndex = 66
        ' 
        ' CommercialNameTB
        ' 
        CommercialNameTB.Location = New Point(20, 470)
        CommercialNameTB.Name = "CommercialNameTB"
        CommercialNameTB.Size = New Size(367, 27)
        CommercialNameTB.TabIndex = 65
        ' 
        ' FormalNameTB
        ' 
        FormalNameTB.Location = New Point(393, 470)
        FormalNameTB.Name = "FormalNameTB"
        FormalNameTB.Size = New Size(320, 27)
        FormalNameTB.TabIndex = 64
        ' 
        ' MangerNumberTB
        ' 
        MangerNumberTB.Location = New Point(427, 403)
        MangerNumberTB.Name = "MangerNumberTB"
        MangerNumberTB.Size = New Size(288, 27)
        MangerNumberTB.TabIndex = 63
        ' 
        ' ManagerTB
        ' 
        ManagerTB.Location = New Point(427, 351)
        ManagerTB.Name = "ManagerTB"
        ManagerTB.Size = New Size(286, 27)
        ManagerTB.TabIndex = 62
        ' 
        ' ManagerIDTB
        ' 
        ManagerIDTB.Location = New Point(427, 299)
        ManagerIDTB.Name = "ManagerIDTB"
        ManagerIDTB.Size = New Size(295, 27)
        ManagerIDTB.TabIndex = 61
        ' 
        ' NameInEnglishTB
        ' 
        NameInEnglishTB.Location = New Point(408, 198)
        NameInEnglishTB.Name = "NameInEnglishTB"
        NameInEnglishTB.Size = New Size(305, 27)
        NameInEnglishTB.TabIndex = 60
        ' 
        ' CustomerAccountNumberTB
        ' 
        CustomerAccountNumberTB.Location = New Point(579, 71)
        CustomerAccountNumberTB.Name = "CustomerAccountNumberTB"
        CustomerAccountNumberTB.Size = New Size(141, 27)
        CustomerAccountNumberTB.TabIndex = 59
        ' 
        ' CommercialRecordAndIdentityTB
        ' 
        CommercialRecordAndIdentityTB.Location = New Point(408, 135)
        CommercialRecordAndIdentityTB.Name = "CommercialRecordAndIdentityTB"
        CommercialRecordAndIdentityTB.Size = New Size(310, 27)
        CommercialRecordAndIdentityTB.TabIndex = 58
        ' 
        ' AddressTA
        ' 
        AddressTA.Location = New Point(20, 135)
        AddressTA.Name = "AddressTA"
        AddressTA.Size = New Size(382, 90)
        ...
        downCustomersPB.Location = New Point(42, 19)
        ...
        UpCustomersPB.Location = New Point(5, 19)
        ...
        CountryCB.Location = New Point(17, 295)
        ...
        AreaCB.Location = New Point(17, 350)
        AreaCB.Name = "AreaCB"
        ...
        Label20.Location = New Point(296, 443)
        ...
        Label19.Location = New Point(377, 790)
        ...
        Label18.Location = New Point(365, 729)
        ...
        Label17.Location = New Point(584, 790)
        ...
        Label16.Location = New Point(569, 735)
        ...
        Label15.Location = New Point(571, 661)
        ...
        Label14.Location = New Point(395, 662)
        ...
        Label13.Location = New Point(621, 544)
        ...
        Label10.Location = New Point(645, 379)
        ...
        Label9.Location = New Point(375, 266)
        ...
        Label8.Location = New Point(350, 327)
        ...
        Label7.Location = New Point(639, 275)
        ...
        Label6.Location = New Point(668, 329)
        ...
        Label5.Location = New Point(333, 112)
        ...
        Label4.Location = New Point(611, 173)
        ...
        Label3.Location = New Point(599, 44)
        ...
        ' GroupBox5
        ' 
        GroupBox5.Controls.Add(ClosingPB)
        GroupBox5.Location = New Point(6, 2)
        GroupBox5.Name = "GroupBox5"
        GroupBox5.Size = New Size(1686, 71)
        GroupBox5.TabIndex = 7
        GroupBox5.TabStop = False
        ' 
        ' ClosingPB
        ' 
        ClosingPB.Image = CType(resources.GetObject("ClosingPB.Image"), Image)
        ClosingPB.Location = New Point(8, 18)
        ClosingPB.Name = "ClosingPB"
        ClosingPB.Size = New Size(32, 35)
        ClosingPB.SizeMode = PictureBoxSizeMode.StretchImage
        ClosingPB.TabIndex = 0
        ClosingPB.TabStop = False
        ' 
        ' GroupBox2
        ' 
        ...
        GroupBox2.Controls.Add(CustomerSearchPB)
        ...
        GroupBox2.Location = New Point(1629, 154)
        GroupBox2.Margin = New Padding(3, 4, 3, 4)
        GroupBox2.Name = "GroupBox2"
        GroupBox2.Padding = New Padding(3, 4, 3, 4)
        GroupBox2.RightToLeft = RightToLeft.Yes
        GroupBox2.Size = New Size(54, 379)
        ...
        Delegations.Location = New Point(8, 309)
        Delegations.Name = "Delegations"
        Delegations.Size = New Size(41, 48)
        Delegations.SizeMode = PictureBoxSizeMode.StretchImage
        Delegations.TabIndex = 85
        Delegations.TabStop = False
        ' 
        ' CustomerSearchPB
        ' 
        CustomerSearchPB.Image = CType(resources.GetObject("CustomerSearchPB.Image"), Image)
        CustomerSearchPB.Location = New Point(9, 93)
        CustomerSearchPB.Name = "CustomerSearchPB"
        CustomerSearchPB.Size = New Size(39, 40)
        CustomerSearchPB.SizeMode = PictureBoxSizeMode.StretchImage
        CustomerSearchPB.TabIndex = 84
        CustomerSearchPB.TabStop = False
        ' 
        ' refreshPB
        ' 
        refreshPB.Image = CType(resources.GetObject("refreshPB.Image"), Image)
        refreshPB.Location = New Point(12, 22)
        refreshPB.Name = "refreshPB"
        refreshPB.Size = New Size(32, 35)
        refreshPB.SizeMode = PictureBoxSizeMode.StretchImage
        refreshPB.TabIndex = 78
        refreshPB.TabStop = False
        ' 
        ' AddAttachmentsBT
        ' 
        AddAttachmentsBT.Image = CType(resources.GetObject("AddAttachmentsBT.Image"), Image)
        AddAttachmentsBT.Location = New Point(8, 168)
        AddAttachmentsBT.Name = "AddAttachmentsBT"
        AddAttachmentsBT.Size = New Size(40, 46)
        AddAttachmentsBT.SizeMode = PictureBoxSizeMode.StretchImage
        AddAttachmentsBT.TabIndex = 80
        AddAttachmentsBT.TabStop = False
        ' 
        ' DocumentsSettings
        ' 
        DocumentsSettings.Image = CType(resources.GetObject("DocumentsSettings.Image"), Image)
        DocumentsSettings.Location = New Point(8, 230)
        DocumentsSettings.Name = "DocumentsSettings"
        DocumentsSettings.Size = New Size(43, 39)
        DocumentsSettings.SizeMode = PictureBoxSizeMode.StretchImage
        DocumentsSettings.TabIndex = 81
        ...
        CType(ClosingPB, ComponentModel.ISupportInitialize).EndInit()
        GroupBox2.ResumeLayout(False)
        CType(Delegations, ComponentModel.ISupportInitialize).EndInit()
        CType(CustomerSearchPB, ComponentModel.ISupportInitialize).EndInit()
        CType(refreshPB, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents ClosingPB As PictureBox
    Friend WithEvents CustomerSearchPB As PictureBox
